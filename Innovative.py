...
elelabel = Label(window, text="Enter R: ", font=('Georgia', 12))
...
fdlabel = Label(window, text="Enter F.D.: ", font=('Georgia', 12))
...
cbutton = Button(window, command=run, text="Compute", font=('Georgia', 9), fg='green')
cbutton.grid(row=3, column=0, padx=3, pady=5, sticky=W)
emptyLabel1 = Label(window, fg='navy', font=('Georgia', 9))
emptyLabel1.grid(row=4, column=0, sticky=W)
emptyLabel2 = Label(window, fg='navy', font=('Georgia', 9))
emptyLabel2.grid(row=4, column=1, sticky=W)
emptyLabel3 = Label(window, fg='navy', font=('Georgia', 9))
emptyLabel3.grid(row=5, column=0, sticky=W)
emptyLabel4 = Label(window, fg='navy', font=('Georgia', 9))
emptyLabel4.grid(row=5, column=1, sticky=W)
emptyLabel5 = Label(window, fg='navy', font=('Georgia', 9))
emptyLabel5.grid(row=6, column=0, sticky=W)
emptyLabel6 = Label(window, fg='navy', font=('Georgia', 9))
